...
- `reference/gof-mappings.md` (to cite GoF patterns if any)
...
5. If the matrix cell is populated, present the top 1 to 3 principles with rationale. Expand them using `reference/principles.md` and `reference/gof-mappings.md`.
